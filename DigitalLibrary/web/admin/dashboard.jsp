...
<body>
    <%
        // Kiểm tra đăng nhập và quyền ADMIN (từ Reader hoặc Employee)
        Reader reader = (Reader) session.getAttribute("reader");
        Employee employee = (Employee) session.getAttribute("employee");
        String userRole = (String) session.getAttribute("userRole");
        
        if ((reader == null && employee == null) || userRole == null || !"ADMIN".equals(userRole)) {
        ...
        <main class="main-content">
            ...
            <div class="dashboard-content">
                <div class="welcome-card">
                    <h2>Chào mừng, <%= userName != null ? userName : "Admin" %>!</h2>
                    <p>Bạn đang ở trang quản trị hệ thống Digital Library</p>
                    <% if (userRole != null) { %>
