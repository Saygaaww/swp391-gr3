                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="category-stats">
                                            <span class="book-count">
                                                ...
                                                ${requestScope['bookCount_'.concat(category.categoryId)]} cuốn sách
                                            </span>
                                        </div>
                ...
                <c:otherwise>
                    <div class="alert alert-info text-center">
                        <div class="no-results-content">
                            ...
                            <a href="${pageContext.request.contextPath}/categories" class="btn btn-primary mt-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="quick-link-card">
                        ...
                        <a href="${pageContext.request.contextPath}/categories?sort=popular" class="btn btn-outline">
