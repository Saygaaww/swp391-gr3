<%-- Fine Summary - Tổng hợp phạt theo theme đen/trắng --%>
...
<div class="container py-5">
    <h2 class="fw-bold mb-4">Fine Summary</h2>
    <p class="text-muted">Tổng hợp phạt trả muộn.</p>
    <p class="text-muted">Chưa có phạt nào.</p>
