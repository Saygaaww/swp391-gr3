...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-add { background: #5a5a5a; }
        .header-edit { background: #d39e00; }
        ...
        .card-header-edit { border-bottom-color: #ffc107; }
        .card-header h2 { font-size: 24px; color: #333; margin-bottom: 10px; }
        ...
        .mode-badge-add { background: #5a5a5a; color: #fff; }
        .mode-badge-edit { background: #ffc107; color: #000; }
...
<body>
    <div class="header ${mode == 'edit' ? 'header-edit' : 'header-add'}">
        <h1>${mode == 'edit' ? '✏️ Sửa thông tin sách' : '➕ Thêm sách mới'}</h1>
    </div>
        ...
        <div class="card">
            <div class="card-header ${mode == 'edit' ? 'card-header-edit' : ''}">
                <div class="mode-badge ${mode == 'edit' ? 'mode-badge-edit' : 'mode-badge-add'}">
                    ${mode == 'edit' ? '✏️ CHẾ ĐỘ SỬA' : '➕ CHẾ ĐỘ THÊM MỚI'}
                </div>
                <h2>
                    <c:choose>
            ...
            <form action="${pageContext.request.contextPath}/admin/book-form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="coverUrl" value="${book.coverUrl}" placeholder="https://example.com/cover.jpg">
                </div>
