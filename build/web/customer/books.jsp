...
<div class="container my-5">
    <h2 class="mb-4">Kho sách thư viện</h2>
    <p class="text-muted">Nhấn vào sách để xem chi tiết và gửi yêu cầu mượn.</p>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4 col-lg-3">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <% } %>
                    <a href="<%= request.getContextPath() %>/BookDetailServlet?id=<%= b.getBookId() %>" class="btn btn-outline-dark btn-sm w-100">Xem chi tiết</a>
                </div>
            </div>
        </div>
        <%
        ...
        %>
        <div class="col-12">
            <div class="alert alert-info">Chưa có sách trong kho.</div>
        </div>
        <% } %>
    </div>
</div>
