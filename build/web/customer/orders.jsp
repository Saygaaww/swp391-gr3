...
<div class="user-home">
    <div class="container py-5">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise><span class="badge bg-secondary ms-2">${o.status}</span></c:otherwise>
                                    </c:choose>
                                    <a href="<%= ctx%>/customer/order-detail?orderId=${o.orderId}" class="btn btn-link btn-sm ms-2 p-0">Xem chi tiết</a>
                                </div>
                                <strong><fmt:formatNumber value="${o.totalAmount}" type="number" groupingUsed="true" maxFractionDigits="0"/> ₫</strong>
                            </div>
        ...
        <a href="<%= ctx%>/customer/home_1.jsp" class="btn btn-outline-dark mt-3">← Trang chủ</a>
    </div>
</div>
