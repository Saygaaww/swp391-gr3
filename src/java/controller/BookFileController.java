...
/**
 * BookFileController - Handle upload/update of book digital content file
 * (contentPath)
...
public class BookFileController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (uploadsDirPath == null) {
                uploadsDirPath = getServletContext().getRealPath("/") + File.separator + "uploads" + File.separator
                        + "books";
            }
            ...
            String uniqueFileName = "book_" + bookId + "_" + System.currentTimeMillis() + "_" + safeBaseName
                    + fileExtension;
            ...
            try {
                if (bookDAO.updateBookContentPath(bookId, relativePath)) {
                    ...
                    setErrorAndForward(request, response, bookId,
                            "Không thể cập nhật đường dẫn file. Vui lòng thử lại.");
                }
            } finally {
                bookDAO.close();
            }
    ...
    private void setErrorAndForward(HttpServletRequest request, HttpServletResponse response, int bookId,
            String errorMessage)
            throws ServletException, IOException {
    ...
    private void handleUnauthorized(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("error",
                "Bạn không có quyền cập nhật file nội dung sách. Chỉ Librarian/Seller mới có thể thực hiện thao tác này.");
