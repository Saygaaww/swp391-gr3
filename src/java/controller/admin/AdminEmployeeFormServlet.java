    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (isEdit) {
                ...
                if (success) {
                    final String empEmail = employee.getEmail();
                    final String empName = employee.getFullName();
                    final String empPass = password;
                    
                    // Lấy tên quyền từ ID (Mặc định là Nhân viên)
                    String roleName = "Nhân viên hệ thống";
                    try {
                        int rId = employee.getRoleId();
                    ...
                    final String assignedRole = roleName;
                    
                    // Async sending
                    new Thread(() -> {
                        util.EmailUtil.sendNewEmployeeEmail(empEmail, empName, empPass, assignedRole);
                    }).start();
                }
