...
public class UserDAO {
    ...
    public boolean registerByEmail(String fullName, String email, String password) {
    ...
    """;
        ...
        String insertAccount = """
        INSERT INTO User_Accounts(user_id, email, password_hash, provider,provider_user_id)
        VALUES (?, ?, ?, 'EMAIL', ?)
    """;
