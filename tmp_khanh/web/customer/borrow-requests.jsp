<%-- Borrow Request Status - Trạng thái yêu cầu mượn theo theme đen/trắng --%>
...
<div class="container py-5">
    <h2 class="fw-bold mb-4">Borrow Request Status</h2>
    <p class="text-muted">Trạng thái yêu cầu mượn sách.</p>
