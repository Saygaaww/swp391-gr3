<%-- Borrowed Items - Sách đang mượn theo theme đen/trắng --%>
...
<div class="container py-5">
    <h2 class="fw-bold mb-4">Borrowed Items</h2>
    <p class="text-muted">Sách đang mượn và ngày hết hạn.</p>
    <p class="text-muted">Chưa có sách đang mượn.</p>
