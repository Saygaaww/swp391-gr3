<%-- Reservations - Đặt chỗ sách theo theme đen/trắng --%>
...
<div class="container py-5">
    <h2 class="fw-bold mb-4">Reservation Status</h2>
    <p class="text-muted">Đặt chỗ khi sách hết bản.</p>
    <p class="text-muted">Chưa có đặt chỗ nào.</p>
