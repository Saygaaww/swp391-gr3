...
<div class="container py-5">
    ...
    <p class="text-muted">Đánh giá và nhận xét sách bạn đã sở hữu (1–5 sao). Mỗi sách một đánh giá.</p>
    ...
    <c:if test="${not empty ownedBooks}">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<%= ctx %>/customer/reviews" method="post" class="row g-2 align-items-end">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="comment" class="form-control" placeholder="Tùy chọn">
                    </div>
                    <div class="col-md-2">
            ...
            <div class="list-group">
                <c:forEach items="${reviews}" var="r">
                    <div class="list-group-item">
                        ...
                        <small class="text-secondary">${r.updatedAt != null ? r.updatedAt : r.createdAt}</small>
                    </div>
                </c:forEach>
            </div>
        </c:otherwise>
