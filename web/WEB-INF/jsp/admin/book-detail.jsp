...
<body>
    <div class="header">
        ...
        <div class="header-right">
            ...
            <a href="${pageContext.request.contextPath}/auth/logout" class="btn-logout">Dang xuat</a>
        </div>
    </div>
                            ...
                            <div class="value">
                                <c:choose>
                                    <c:when test="${not empty book.createdAt}">
                                        ${book.createdAt.toLocalDate()} ${book.createdAt.toLocalTime().withNano(0)}
                                    </c:when>
                            ...
                            <div class="value">
                                <c:choose>
                                    <c:when test="${not empty book.updatedAt}">
                                        ${book.updatedAt.toLocalDate()} ${book.updatedAt.toLocalTime().withNano(0)}
                                    </c:when>
