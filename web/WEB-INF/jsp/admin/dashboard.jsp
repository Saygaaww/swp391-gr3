                ...
                <div class="dashboard-container">
                    ...
                    <div class="header-banner">
                        <div class="header-content">
                            <h1>Chao mung, <%= currentAdmin !=null ? currentAdmin.getFullName() : "System Admin" %>!
                            </h1>
                        ...
                        <div class="header-date">
                            ...
                            <% java.time.LocalDate today=java.time.LocalDate.now(); java.time.format.DateTimeFormatter
                                formatter=java.time.format.DateTimeFormatter.ofPattern("'Thứ' e, dd 'tháng' MM, yyyy",
                                new java.util.Locale("vi", "VN" )); out.print(today.format(formatter)); %>
                        </div>

                        <a href="<%= request.getContextPath() %>/auth/logout"
                            style="position: absolute; right: 24px; bottom: 24px; color: #9ca3af; text-decoration: none; font-size: 1.2rem; transition: color 0.2s;"
                            title="Đăng xuất" onmouseover="this.style.color='#fff'"
