                    ...
                    <main class="container py-5" style="min-height: 70vh; margin-top: 80px;">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h2 class="mb-0" style="font-weight: 700;"><i class="fas fa-user-tie"
                                    style="color:#4f46e5;"></i> Quản lý nhân viên</h2>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="searchKeyword"
                                            placeholder="Tim theo tên hoặc email..." value="${keyword}">
                                        <button class="btn btn-primary"
                                            style="background:#1a1a2e; border-color:#1a1a2e;"
                                            onclick="applyFilters()"><i class="fas fa-search"></i> Tim</button>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    ...
                                    <c:choose>
                                        <c:when test="${empty employeeList}">
                                            <div class="text-center p-5 text-muted">
                                                ...
                                                <h5>Không có dự liệu nhân viên</h5>
                                                <p>${not empty keyword ? 'Không tim thấyy kết quả phù hợp.' : 'Hệ thống
                                                    chưa có nhân viên.'}</p>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${r.roleName == 'Admin'}">
                                                                        <span class="badge bg-secondary">Bảo vệ</span>
                                                                    </c:when>
                                        ...
                                        <nav>
                                            <ul class="pagination pagination-sm mb-0">
                                                <li class="page-item ${currentPage <= 1 ? 'disabled' : ''}">
                                                    <a class="page-link"
                                                        href="javascript:goToPage(${currentPage - 1})">Truớc</a>
                                                </li>
