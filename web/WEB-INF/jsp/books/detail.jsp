            ...
            <c:choose>
                <c:when test="${not empty book}">
                    ...
                    <div class="book-hero">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <div class="book-cover-section d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-md-8">
                                <div class="book-info-section">
                                    ...
                                    <div class="book-actions">
                                        ...
                                        <a href="${pageContext.request.contextPath}/books" class="btn-outline-modern">
                ...
                <c:otherwise>
                    ...
                    <div class="alert alert-warning text-center">
                        <div class="no-results-content">
                            ...
                            <a href="${pageContext.request.contextPath}/books" class="btn-primary-modern mt-3">
                                <i class="fas fa-arrow-left"></i>
