    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                ...
                <p>Cập nhật thông tin sách trong hệ thống</p>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/admin/book-edit" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="coverUrl" value="${book.coverUrl}">
                </div>
                
                <!-- Đường dẫn file -->
                <div class="form-group">
                    <label>Đường dẫn file PDF</label>
                    <input type="text" name="contentPath" value="${book.contentPath}">
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="currency">
                            <option value="VND" ${book.currency == 'VND' ? 'selected' : ''}>VND (₫)</option>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="totalPages" min="1" value="${book.totalPages}">
                    </div>
                    <div class="form-group">
                        <label>Số trang xem trước</label>
                        <input type="number" name="previewPages" min="0" value="${book.previewPages}">
                    </div>
                </div>
                        ...
                        <select name="categoryId">
                            ...
                            <c:forEach var="category" items="${categories}">
                                <option value="${category.categoryId}" 
                                        ${book.categoryId == category.categoryId ? 'selected' : ''}>
