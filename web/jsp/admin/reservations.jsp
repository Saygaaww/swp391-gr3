...
<style>
        ...
        .subtle { color: #666; font-size: 14px; margin-top: 4px; }
        ...
        .btn { border: 1px solid #d6d9e0; background: #fff; border-radius: 8px; padding: 8px 12px; cursor: pointer; }
        ...
        .card { background: #fff; border: 1px solid #eceff4; border-radius: 12px; padding: 12px; margin-bottom: 16px; }
        .alert { padding: 10px 12px; border-radius: 8px; margin-bottom: 12px; }
        .alert.success { background: #ecfdf3; border: 1px solid #b9f0d0; color: #166534; }
        .alert.error { background: #fef2f2; border: 1px solid #fecaca; color: #991b1b; }
        table { width: 100%; border-collapse: collapse; background: #fff; border-radius: 12px; overflow: hidden; }
        th, td { padding: 10px; border-bottom: 1px solid #eef1f5; text-align: left; font-size: 14px; }
        th { background: #f8fafc; color: #475569; }
        tr:hover td { background: #fcfdff; }
        .badge { padding: 3px 8px; border-radius: 999px; font-size: 12px; font-weight: 600; display: inline-block; }
        .st-waiting { background: #e5e7eb; color: #374151; }
        .st-ready { background: #fef3c7; color: #92400e; }
        .st-expired { background: #fee2e2; color: #991b1b; }
        .st-fulfilled { background: #dcfce7; color: #166534; }
        .st-cancelled { background: #e2e8f0; color: #334155; }
        .row-actions { display: flex; gap: 6px; justify-content: flex-end; }
        .muted { color: #94a3b8; }
        .right { text-align: right; }
        select, input[type="number"] { border: 1px solid #d6d9e0; border-radius: 8px; padding: 7px 9px; }
    </style>
