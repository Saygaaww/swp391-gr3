    ...
    <body>
        <div class="card">
            <div class="logo">
                ...
                <p>Chúng tôi đã gửi mã OTP 6 số đến email <strong>${sessionScope.pendingGoogleEmail}</strong> của bạn.
                </p>
            </div>
            ...
            <a href="${pageContext.request.contextPath}/auth/login" class="back-link">Hủy và Quay lại đăng nhập</a>
        </div>
