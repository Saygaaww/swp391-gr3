...
<head>
    ...
    <style>
        ...
        .book-card-price.free { color: #48bb78; }
        ...
        .book-card-footer a:hover { color: #764ba2; }
        ...
        @media (max-width: 768px) {
            .author-banner { flex-direction: column; text-align: center; }
            .author-body { padding: 1.5rem; }
            .author-banner-info h1 { font-size: 1.7rem; }
