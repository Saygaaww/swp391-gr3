...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bd-breadcrumb a { color: var(--teal); text-decoration: none; transition: color .2s; }
        .bd-breadcrumb a:hover { color: var(--teal-lt); }
        .bd-breadcrumb .sep { color: var(--line); }
        .bd-breadcrumb .cur { color: var(--ink2); font-weight: 500; }
        ...
        .bd-cover-panel img:hover { transform: scale(1.03) rotate(-1deg); }
        ...
        .bd-cat-tag:hover { background: var(--teal); color: #fff; }
        ...
        .bd-author-line a:hover { text-decoration: underline; }
        ...
        .bd-price-unit { font-size: 13px; color: var(--muted); }
        .bd-price-box.free {
            background: #e8f5e9;
            border-color: #c8e6c9;
        }
        .bd-price-box.free .bd-price-num { color: var(--green); font-size: 22px; }
        ...
        .bd-btn-teal  { background: var(--teal); color: #fff; }
        .bd-btn-teal:hover  { background: var(--teal-lt); color:#fff; transform:translateY(-2px); box-shadow:0 6px 20px rgba(45,106,94,.35); }
        .bd-btn-green { background: var(--green); color: #fff; }
        .bd-btn-green:hover { background: var(--green-lt); color:#fff; transform:translateY(-2px); box-shadow:0 6px 20px rgba(46,125,50,.3); }
        .bd-btn-outline { background: transparent; border: 1.5px solid var(--line); color: var(--ink2); }
        .bd-btn-outline:hover { border-color: var(--teal); color: var(--teal); background: var(--teal-bg); }
        ...
        .bd-left { display: flex; flex-direction: column; gap: 24px; }
        ...
        .bd-card-hd i { color: var(--teal); font-size: 13px; }
        .bd-card-bd { padding: 24px; }

        .bd-desc { font-size: 15px; line-height: 1.85; color: var(--ink2); }
        ...
        .bd-stat-lbl { color: var(--muted); }
        .bd-stat-val { color: var(--ink); font-weight: 500; }
        .bd-stat-val.ok { color: var(--green); }
        ...
        .bd-bio-txt { font-size: 14px; line-height: 1.75; color: var(--ink2); }
        ...
        .bd-notfound i { font-size: 48px; color: var(--line); margin-bottom: 16px; display: block; }
        .bd-notfound h4 { font-family:'Cormorant Garamond',serif; font-size:26px; margin-bottom:8px; }
        .bd-notfound p { color: var(--muted); margin-bottom: 24px; }
        ...
        .student-badge i { color: var(--amber); }

        /* ── RESPONSIVE ────────────────────────── */
        @media (max-width: 860px) {
            .bd-hero { grid-template-columns: 1fr; }
            .bd-cover-panel { padding: 36px 24px; }
            .bd-cover-panel img { max-width: 160px; }
            .bd-info-panel { padding: 28px 24px; }
                ...
                <div class="bd-info-panel">
                    ...
                    <div class="bd-actions">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="#book-preview" class="bd-btn bd-btn-teal">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        cards.forEach((card, i) => { card.style.animationDelay = (0.2 + i * 0.1) + 's'; });
    });
</script>
</body>
</html>
