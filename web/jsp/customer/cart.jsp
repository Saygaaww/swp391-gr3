                                ...
                                <div class="container py-5">
                                    ...
                                    <c:choose>
                                        <c:when test="${empty cart || empty cart.items}">
                                            ...
                                            <a href="<%= ctx %>/customer/orders" class="btn btn-card me-2">Xem giỏ hàng</a>
                                            <!-- Nút quay lại trang mua sácch -->
                                        ...
                                        <c:otherwise>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form action="<%= ctx %>/customer/cart/remove"
                                                                        method="post" class="d-inline"
                                                                        onsubmit="return confirm('Xóa Sácch Này?')">
                                                                        <input type="hidden" name="cartItemId"
                                                                            value="${item.cartItemId}">
                                                                        <button type="submit"
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                <a href="<%= ctx %>/books" class="btn btn-outline-dark">Về kho sách
                                                    </a>
                                                <div>
                                                    <strong>Tổng:
