                        ...
                        <div class="profile-header">
                            <div class="avatar-circle" id="heroAvatar">
                                <% if (currentReader != null && currentReader.getAvatarUrl() != null &&
                                    ...
                                    <img src="<%= currentReader.getAvatarUrl() %>" alt="Avatar" id="heroAvatarImg">
                                    <% } else { %>
                                        <span id="heroAvatarInitials"><%= currentReader != null ? currentReader.getInitials() : "?" %></span>
                                            <% } %>
                            </div>
                                    ...
                                    <% } %>
                                        ...
                                        <div class="card">
                                            <div class="card-title"><i class="fas fa-user-edit"></i> Chỉnh sửa thông tin
                                                cá nhân</div>
                                            <form method="post" action="<%= request.getContextPath() %>/profile/edit" id="editForm" enctype="multipart/form-data">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group full">
                                                        ...
                                                        <div style="display: flex; align-items: center; gap: 15px;">
                                                            <div class="avatar-circle" id="editAvatarPreview" style="width: 60px; height: 60px; font-size: 1.2rem;">
                                                                <% if (currentReader != null && currentReader.getAvatarUrl() != null && !currentReader.getAvatarUrl().isBlank()) { %>
                                                                    <img src="<%= currentReader.getAvatarUrl() %>" alt="Preview">
                                                                <% } else { %>
                                                                    <span><%= currentReader != null ? currentReader.getInitials() : "?" %></span>
                                                                <% } %>
                                                            </div>
                                                            <div style="flex-grow: 1;">
                                                                <input type="file" id="avatarFile" name="avatarFile" accept=".jpg, .jpeg, .png, .gif" 
                                                                       style="display: none;" onchange="previewAvatar(this)">
                                                                <button type="button" class="btn-primary" style="padding: 8px 15px; font-size: 0.8rem; background: #9ca3af;" 
                                                                        onclick="document.getElementById('avatarFile').click()">
                                                                    <i class="fas fa-camera"></i> Chọn ảnh mới
                                                                </button>
                                                                <div style="font-size: 0.7rem; color: #6b7280; margin-top: 5px;">Hỗ trợ JPG, PNG, GIF. Tối đa 2MB.</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <script>
                        function previewAvatar(input) {
                            ...
                            if (!validTypes.includes(file.type)) {
                                ...
                                input.value = '';
                                input.setAttribute('data-rejected', 'true');
                                return;
                            }
                            ...
                            reader.onload = function(e) {
                                ...
                                // Cập nhật preview nhỏ trong card
                                const editPreview = document.getElementById('editAvatarPreview');
                                editPreview.innerHTML = '<img src="' + dataUrl + '" alt="Preview" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">';
                                
                                // Cập nhật hero avatar preview to đùng ở trên
                                const heroAvatar = document.getElementById('heroAvatar');
                                if (heroAvatar) {
                                    heroAvatar.innerHTML = '<img src="' + dataUrl + '" alt="Avatar" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">';
                                }
                            };
