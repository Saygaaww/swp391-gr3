...
<%
    ...
    if (sessionUser instanceof model.Reader) {
        ...
        pName = r.getFullName();
        pEmail = r.getEmail();
        pPhone = r.getPhone() != null && !r.getPhone().isEmpty() ? r.getPhone() : "Chua cập nhật";
        pRole = r.getRoleName() != null ? r.getRoleName() : "Ðộc giả";
    ...
    <body>
        ...
        <script>
            ...
            document.getElementById('editForm').addEventListener('submit', function (e) {
                ...
                // 2. Block submit if an invalid file was selected (data-rejected is set even after clearing input.value)
                if (avatarFile.getAttribute('data-rejected') === 'true') {
                    e.preventDefault();
                    alert('Vui lòng chọn lại ảnh hợp lệ (JPG, PNG, GIF) hoặc hủy thay đổi trước khi lưu.');
                    return;
                }
            });
            ...
            function previewAvatar(input) {
                ...
                reader.onload = function (e) {
                    ...
                    const modalPreview = document.getElementById('modalAvatar');
                    modalPreview.innerHTML = '<img src="' + dataUrl + '" alt="preview" style="width:100%;height:100%;object-fit:cover;">';
                    
                    // Update hero avatar preview (real-time update on page)
                    const heroAvatar = document.getElementById('heroAvatar');
                    heroAvatar.innerHTML = '<img src="' + dataUrl + '" alt="Avatar" id="heroAvatarImg" style="width:100%;height:100%;object-fit:cover;">';
                };
